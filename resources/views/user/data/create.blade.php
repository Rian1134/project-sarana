...
<div class="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
    <div class="flex flex-col gap-3 sm:gap-4">
        ...
        <!-- Form -->
        <form action="{{ route('user.data.store') }}" method="POST" id="saranaForm" class="flex flex-col gap-3 sm:gap-4">
            @csrf
                ...
                <div class="p-3 sm:p-4">
                    <div class="grid grid-cols-3 gap-2 sm:gap-4">
                        ...
                        <x-form.input
                            ...
                            min="0"
                            required
                            :value="old('jumlah_rombel_viii', 0)"
                        />
                        <x-form.input
                    ...
                    <div class="p-3 sm:p-4">
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <x-form.input
                                ...
                                min="0"
                                required
                                :value="old('toilet_siswa_rusak', 0)"
                            />
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                <x-form.radio 
                                    ...
                                    value="ada" 
                                    label="Ada" 
                                    :checked="old('perpustakaan_ada_tidak') == 'ada'"
                                />
                                <x-form.radio 
                                    name="perpustakaan_ada_tidak" 
                                    value="tidak_ada" 
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                <x-form.radio 
                                    ...
                                    value="ada" 
                                    label="Ada" 
                                    :checked="old('kepala_sekolah_ada_tidak') == 'ada'"
                                />
                                <x-form.radio 
                                    name="kepala_sekolah_ada_tidak" 
                                    value="tidak_ada" 
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                <x-form.radio 
                                    ...
                                    value="ada" 
                                    label="Ada" 
                                    :checked="old('ruang_guru_ada_tidak') == 'ada'"
                                />
                                <x-form.radio 
                                    name="ruang_guru_ada_tidak" 
                                    value="tidak_ada" 
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                <x-form.radio 
                                    ...
                                    value="ada" 
                                    label="Ada" 
                                    :checked="old('kantor_tu_ada_tidak') == 'ada'"
                                />
                                <x-form.radio 
                                    name="kantor_tu_ada_tidak" 
                                    value="tidak_ada" 
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                    <x-form.radio 
                                        ...
                                        value="ada" 
                                        label="Ada" 
                                        :checked="old('lab_ipa_ada_tidak') == 'ada'"
                                    />
                                    <x-form.radio 
                                        name="lab_ipa_ada_tidak" 
                                        value="tidak_ada" 
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                    <x-form.radio 
                                        ...
                                        value="ada" 
                                        label="Ada" 
                                        :checked="old('lab_komputer_ada_tidak') == 'ada'"
                                    />
                                    <x-form.radio 
                                        name="lab_komputer_ada_tidak" 
                                        value="tidak_ada" 
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                    <x-form.radio 
                                        ...
                                        value="ada" 
                                        label="Ada" 
                                        :checked="old('rumah_dinas_ada_tidak') == 'ada'"
                                    />
                                    <x-form.radio 
                                        name="rumah_dinas_ada_tidak" 
                                        value="tidak_ada" 
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                    <x-form.radio 
                                        ...
                                        value="ada" 
                                        label="Ada" 
                                        :checked="old('rumah_ibadah_ada_tidak') == 'ada'"
                                    />
                                    <x-form.radio 
                                        name="rumah_ibadah_ada_tidak" 
                                        value="tidak_ada" 
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                    <x-form.radio 
                                        ...
                                        value="ada" 
                                        label="Ada" 
                                        :checked="old('lapangan_sekolah_ada_tidak') == 'ada'"
                                    />
                                    <x-form.radio 
                                        name="lapangan_sekolah_ada_tidak" 
                                        value="tidak_ada" 
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3 sm:gap-4 mt-1">
                                    <x-form.radio 
                                        ...
                                        value="ada" 
                                        label="Ada" 
                                        :checked="old('pagar_ada_tidak') == 'ada'"
                                    />
                                    <x-form.radio 
                                        name="pagar_ada_tidak" 
                                        value="tidak_ada" 
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="p-3 sm:p-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex flex-wrap gap-2">
                        <x-button type="button" variant="primary" size="md" data-modal-open="confirmCreateModal">
                            <i class="bi bi-save me-1"></i>
                            <span class="hidden sm:inline">Simpan Data</span>
                            <span class="sm:hidden">Simpan</span>
                        </x-button>
                        <x-button type="reset" variant="warning" size="md">
...
<x-modal id="confirmCreateModal" size="sm" centered>
    <x-slot:header>
    ...
    <div class="text-center py-4">
        ...
        <p class="text-sm text-yellow-500 dark:text-yellow-400 mt-2">
            <i class="bi bi-exclamation-triangle"></i> Data yang sudah disimpan tidak dapat diubah kembali!
        </p>
    </div>
    ...
    <x-slot:footer>
        <div class="flex flex-wrap justify-end gap-2 w-full">
            ...
            <x-button variant="primary" type="submit" form="saranaForm">
