        ...
        <div class="flex flex-col gap-3 sm:gap-4">
            ...
            @if ($profileSekolah)
                ...
                <div
                    ...
                    <div
                        class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                            <div
                                class="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold text-sm sm:text-base">
                                <i class="bi bi-building"></i>
                                <span>A. Data Sekolah</span>
                            </div>
                            <div class="flex flex-wrap gap-1.5 w-full sm:w-auto">
                                <a href="{{ route('user.data.edit', $profileSekolah->id) }}"
                                    class="flex-1 sm:flex-none inline-flex">
                                    <x-button variant="warning" size="xs" fullWidth>
                                        <i class="bi bi-database-up me-1"></i>
                                        <span class="inline">Update</span>
                                    </x-button>
                                </a>
                                <x-button type="button" variant="danger" size="xs" data-modal-open="deleteModal"
                    ...
                    <div class="p-3 sm:p-4 space-y-2 sm:space-y-3">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                            <div class="bg-gray-50 dark:bg-gray-700/30 p-2 sm:p-3 rounded-lg">
                                ...
                                <p class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white wrap-break-word">
                            ...
                            <div class="sm:col-span-2 bg-gray-50 dark:bg-gray-700/30 p-2 sm:p-3 rounded-lg">
                                <p class="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">Website</p>
                                <p class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">
                                    @if ($profileSekolah->website)
                                        <a href="{{ $profileSekolah->website }}" target="_blank"
                                            ...
                                            Kunjungi Laman
                                            <i class="bi bi-box-arrow-up-right text-xs ms-1"></i>
                                        </a>
                                    @else
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div
                        class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                        <div
                            class="flex items-center gap-2 text-green-700 dark:text-green-400 font-semibold text-sm sm:text-base">
                        ...
                        <div class="grid grid-cols-3 gap-1.5 sm:gap-3">
                            <div class="bg-green-50 dark:bg-green-900/20 p-2 sm:p-3 rounded-lg text-center">
                                ...
                                <p class="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ $profileSekolah->jumlahSiswa?->vii ?? 0 }}</p>
                            </div>
                            <div class="bg-emerald-50 dark:bg-emerald-900/20 p-2 sm:p-3 rounded-lg text-center">
                                ...
                                <p class="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ $profileSekolah->jumlahSiswa?->viii ?? 0 }}</p>
                            </div>
                            <div class="bg-teal-50 dark:bg-teal-900/20 p-2 sm:p-3 rounded-lg text-center">
                                ...
                                <p class="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ $profileSekolah->jumlahSiswa?->ix ?? 0 }}</p>
                            </div>
                        </div>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div
                        class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20">
                        <div
                            class="flex items-center gap-2 text-purple-700 dark:text-purple-400 font-semibold text-sm sm:text-base">
                ...
                <div class="grid grid-cols-2 gap-3 sm:gap-4 items-stretch">
                    ...
                    <x-card class="flex flex-col h-full">
                        <x-slot:header>
                            <div
                                class="-mx-4 -my-3 sm:-mx-5 h-14 sm:h-16 p-2.5 sm:p-3 flex items-center gap-1.5 sm:gap-2 bg-linear-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 text-blue-700 dark:text-blue-400">
                                <i class="bi bi-building-add text-sm sm:text-lg shrink-0"></i>
                                <span class="text-[10px] sm:text-sm font-semibold leading-tight line-clamp-2">D. Pembangunan Ruang Kelas Baru (RKB)</span>
                            </div>
                        </x-slot:header>

                        <div class="flex-1 flex flex-col items-center justify-center gap-0.5 text-center">
                            <p class="text-xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400">
                                {{ $profileSekolah->ruangKelasBaru?->jumlah ?? 0 }}
                            </p>
                    ...
                    <x-card class="flex flex-col h-full">
                        <x-slot:header>
                            <div
                                class="-mx-4 -my-3 sm:-mx-5 h-14 sm:h-16 p-2.5 sm:p-3 flex items-center gap-1.5 sm:gap-2 bg-linear-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 text-orange-700 dark:text-orange-400">
                                <i class="bi bi-tools text-sm sm:text-lg shrink-0"></i>
                                <span class="text-[10px] sm:text-sm font-semibold leading-tight line-clamp-2">E. Rehabilitasi Ruang Kelas</span>
                            </div>
                        </x-slot:header>

                        <div class="flex-1 flex flex-col items-center justify-center gap-0.5 text-center">
                            <p class="text-xl sm:text-3xl font-bold text-orange-600 dark:text-orange-400">
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div
                        class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-blue-50 to-sky-50 dark:from-blue-900/20 dark:to-sky-900/20">
                        <div
                            class="flex items-center gap-2 text-blue-700 dark:text-blue-400 font-semibold text-sm sm:text-base">
                        ...
                        <div class="grid grid-cols-2 gap-2 sm:gap-4">
                            ...
                            <div class="bg-red-50 dark:bg-red-900/20 p-2 sm:p-3 rounded-lg text-center">
                                ...
                                <p class="text-lg sm:text-2xl font-bold text-red-600 dark:text-red-400">
                                    {{ $profileSekolah->ruangKelas?->rusak ?? 0 }}</p>
                            </div>
                        </div>
                        <div class="mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex justify-between items-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div
                            class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-cyan-50 to-teal-50 dark:from-cyan-900/20 dark:to-teal-900/20">
                            <div
                                class="flex items-center gap-1.5 sm:gap-2 text-cyan-700 dark:text-cyan-400 font-semibold text-[10px] sm:text-sm">
                        ...
                        <div class="p-2 sm:p-3">
                            <div class="grid grid-cols-2 gap-1.5 sm:gap-2">
                                ...
                                <div class="bg-red-50 dark:bg-red-900/20 p-1.5 sm:p-2 rounded-lg text-center">
                                    ...
                                    <p class="text-base sm:text-xl font-bold text-red-600 dark:text-red-400">
                                        {{ $profileSekolah->toiletSiswa?->rusak ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div
                            class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20">
                            <div
                                class="flex items-center gap-1.5 sm:gap-2 text-cyan-700 dark:text-cyan-400 font-semibold text-[10px] sm:text-sm">
                        ...
                        <div class="p-2 sm:p-3">
                            <div class="grid grid-cols-2 gap-1.5 sm:gap-2">
                                ...
                                <div class="bg-red-50 dark:bg-red-900/20 p-1.5 sm:p-2 rounded-lg text-center">
                                    <p class="text-[8px] sm:text-xs text-gray-500 dark:text-gray-400">Rusak</p>
                                    <p class="text-base sm:text-xl font-bold text-red-600 dark:text-red-400">
                                        {{ $profileSekolah->toiletGuru?->rusak ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div
                        class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20">
                        <div
                            class="flex items-center gap-2 text-orange-700 dark:text-orange-400 font-semibold text-sm sm:text-base">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1.5 sm:gap-2">
                            @php
                                $fasilitas = [
                                    [
                                        'label' => 'Pagar',
                                        'value' => $profileSekolah->pagarSekolah?->{'ada/tidak_ada'},
                                        'icon' => 'bi-border-all',
                                    ],
                                    [
                                        'label' => 'Air Bersih',
                                        'value' => $profileSekolah->airBersih?->{'ada/tidak_ada'},
                                        'icon' => 'bi-droplet',
                                    ],
                                    [
                                        'label' => 'Perpustakaan',
                                        'value' => $profileSekolah->ruangPerpustakaan?->{'ada/tidak_ada'},
                                        'icon' => 'bi-book',
                                    ],
                                    [
                                        'label' => 'R. Kepsek',
                                        'value' => $profileSekolah->ruangKepalaSekolah?->{'ada/tidak_ada'},
                                        'icon' => 'bi-person-workspace',
                                    ],
                                    [
                                        'label' => 'R. Guru',
                                        'value' => $profileSekolah->ruangGuru?->{'ada/tidak_ada'},
                                        'icon' => 'bi-easel2',
                                    ],
                                    [
                                        'label' => 'R. TU',
                                        'value' => $profileSekolah->ruangKantorTu?->{'ada/tidak_ada'},
                                        'icon' => 'bi-briefcase',
                                    ],
                                    [
                                        'label' => 'Lab IPA',
                                        'value' => $profileSekolah->labIpa?->{'ada/tidak_ada'},
                                        'icon' => 'bi-flask',
                                    ],
                                    [
                                        'label' => 'Lab Komputer',
                                        'value' => $profileSekolah->labKomputer?->{'ada/tidak_ada'},
                                        'icon' => 'bi-pc-display-horizontal',
                                    ],
                                    [
                                        'label' => 'UKS',
                                        'value' => $profileSekolah->unitKesehatanSekolah?->{'ada/tidak_ada'},
                                        'icon' => 'bi-heart-pulse',
                                    ],
                                    [
                                        'label' => 'Rumah Dinas',
                                        'value' => $profileSekolah->rumahDinas?->{'ada/tidak_ada'},
                                        'icon' => 'bi-house-door',
                                    ],
                                    [
                                        'label' => 'Rumah Ibadah',
                                        'value' => $profileSekolah->rumahIbadah?->{'ada/tidak_ada'},
                                        'icon' => 'bi-building',
                                    ],
                                    [
                                        'label' => 'Lapangan',
                                        'value' => $profileSekolah->lapanganSekolah?->{'ada/tidak_ada'},
                                        'icon' => 'bi-flag',
                                    ],
                                ];
                            @endphp
                            @foreach ($fasilitas as $item)
                                <div
                                    class="flex items-center gap-1 p-1.5 sm:p-2 rounded-lg text-[10px] sm:text-xs {{ $item['value'] == 'ada' ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20' }}">
                                    <i
                                        class="bi {{ $item['icon'] }} {{ $item['value'] == 'ada' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }} text-[10px] sm:text-xs"></i>
                                    <span
                                        class="font-medium text-gray-700 dark:text-gray-300 truncate">{{ $item['label'] }}</span>
                                    <span
                                        class="ml-auto text-[10px] sm:text-xs {{ $item['value'] == 'ada' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                        {{ $item['value'] == 'ada' ? '✓' : '✗' }}
                                    </span>
                                </div>
                            @endforeach
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div
                            class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20">
                            <div
                                class="flex items-center gap-1.5 sm:gap-2 text-yellow-700 dark:text-yellow-400 font-semibold text-[10px] sm:text-sm">
                    ...
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div
                            class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
                            <div
                                class="flex items-center gap-1.5 sm:gap-2 text-purple-700 dark:text-purple-400 font-semibold text-[10px] sm:text-sm">
                ...
                <div id="deleteModal" data-modal class="hidden fixed inset-0 z-50 overflow-y-auto" role="dialog">
                    <div class="flex items-center justify-center min-h-screen p-3 sm:p-4">
                        <div class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm transition-opacity" data-modal-close>
                        </div>
                        <div
                            class="relative w-full max-w-sm bg-white dark:bg-gray-800 rounded-xl shadow-2xl transform transition-all scale-95 mx-3">
                            <div class="flex items-center justify-between p-3 sm:p-4 border-b dark:border-gray-700">
                                <div class="flex items-center gap-2 text-red-600">
                                    <div
                                        class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center">
                            ...
                            <div class="p-3 sm:p-4 text-center">
                                <div
                                    class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                                ...
                                <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 wrap-break-word">
                                    Data sarana <strong
                                        class="text-gray-700 dark:text-gray-300">{{ $profileSekolah->nama_sekolah }}</strong>
                                    akan dihapus permanen.
                                </p>
                            </div>
                            <div class="flex flex-wrap justify-end gap-2 p-3 sm:p-4 border-t dark:border-gray-700">
                                <button type="button" data-modal-close
                                    class="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-xs sm:text-sm font-medium rounded-lg transition-colors dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">
                                ...
                                <form action="{{ route('user.data.destroy', $profileSekolah->id) }}" method="POST"
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="px-3 sm:px-4 py-1.5 sm:py-2 bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm font-medium rounded-lg transition-colors shadow-md hover:shadow-lg">
                ...
                <div
                    ...
                    <div class="text-center py-8 sm:py-12 px-3 sm:px-4">
                        <div class="relative inline-block">
                            <div
                                class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mx-auto mb-4 sm:mb-6">
                                <i class="bi bi-building text-4xl sm:text-5xl text-blue-600 dark:text-blue-400"></i>
                            </div>
                            <div
                                class="absolute -top-1 -right-1 w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-yellow-400 flex items-center justify-center shadow-lg">
