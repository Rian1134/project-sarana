                    ...
                    <x-card>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100">{{ $profileSekolah->nama_sekolah }}</p>
                            </div>
                            <div>
                                <label class="text-sm text-gray-500 dark:text-gray-400 font-medium">NPSN</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100">{{ $profileSekolah->NPSN }}</p>
                            </div>
                            <div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100">{{ $profileSekolah->alamat_sekolah }}</p>
                            </div>
                            <div>
                                <label class="text-sm text-gray-500 dark:text-gray-400 font-medium">Kepala Sekolah</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100">{{ $profileSekolah->nama_kepala_sekolah }}</p>
                            ...
                            <div>
                                ...
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100">{{ $profileSekolah->nomor_hp }}</p>
                            </div>
                        </div>
                ...
                <x-card>
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-3 gap-2 mt-1">
                                    <div class="bg-green-50 dark:bg-green-900/20 p-2 rounded-lg text-center">
                                        <p class="text-xs text-gray-500 dark:text-gray-400">VII</p>
                                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $profileSekolah->jumlahSiswa?->vii ?? 0 }}</p>
                                    </div>
                                    <div class="bg-emerald-50 dark:bg-emerald-900/20 p-2 rounded-lg text-center">
                                        <p class="text-xs text-gray-500 dark:text-gray-400">VIII</p>
                                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $profileSekolah->jumlahSiswa?->viii ?? 0 }}</p>
                                    </div>
                                    <div class="bg-teal-50 dark:bg-teal-900/20 p-2 rounded-lg text-center">
                                        <p class="text-xs text-gray-500 dark:text-gray-400">IX</p>
                                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $profileSekolah->jumlahSiswa?->ix ?? 0 }}</p>
                                    </div>
                                </div>
                            ...
                            <!-- Jumlah Rombel -->
                            <div>
                                <label class="text-sm text-gray-500 dark:text-gray-400 font-medium">Jumlah Rombongan Belajar</label>
                                <div class="grid grid-cols-3 gap-2 mt-1">
                                    <div class="bg-purple-50 dark:bg-purple-900/20 p-2 rounded-lg text-center">
                                        <p class="text-xs text-gray-500 dark:text-gray-400">VII</p>
                                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $profileSekolah->jumlahRombel?->vii ?? 0 }}</p>
                                    </div>
                                    <div class="bg-violet-50 dark:bg-violet-900/20 p-2 rounded-lg text-center">
                                        <p class="text-xs text-gray-500 dark:text-gray-400">VIII</p>
                                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $profileSekolah->jumlahRombel?->viii ?? 0 }}</p>
                                    </div>
                                    <div class="bg-indigo-50 dark:bg-indigo-900/20 p-2 rounded-lg text-center">
                                        <p class="text-xs text-gray-500 dark:text-gray-400">IX</p>
                                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $profileSekolah->jumlahRombel?->ix ?? 0 }}</p>
                                    </div>
                                </div>
                                <div class="mt-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                                    <div class="flex justify-between items-center">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-4 text-center">
                            <label class="text-sm text-gray-500 dark:text-gray-400 font-medium">Jumlah Ruang Kelas</label>
                            <div class="grid grid-cols-3 gap-2 sm:gap-4 mt-3">
                                <div class="bg-sky-50 dark:bg-sky-900/20 p-3 sm:p-6 rounded-lg text-center flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-xl sm:text-4xl font-bold text-gray-900 dark:text-white">{{ $profileSekolah->ruangKelas?->baik ?? 0 }}</p>
                                </div>
                                <div class="bg-rose-50 dark:bg-rose-900/20 p-3 sm:p-6 rounded-lg text-center flex flex-col items-center justify-center">
                                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Rusak</p>
                                    <p class="text-xl sm:text-4xl font-bold text-gray-900 dark:text-white">{{ $profileSekolah->ruangKelas?->rusak ?? 0 }}</p>
                                </div>
