                    ...
                    <x-card>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100">
                                    {{ $profileSekolah->nama_kepala_sekolah }}
                                </p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    NIP: {{ $profileSekolah->NIP }}
                                </p>
                            </div>
                ...
                <x-card>
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                            <label class="text-sm text-gray-500 dark:text-gray-400 font-medium text-center block">
                                Jumlah Ruang Kelas
                            </label>
                            ...
                            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                                ...
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-green-600 dark:text-green-400 font-bold">
                                        {{ $baik }}
                                        <span class="font-normal text-gray-400 text-[10px]">
                                            Baik
                                        </span>
                                    </span>
                            ...
                            <x-table striped hover>
                                ...
                                @empty
                                    <x-table.empty colspan="4"
                                        message="Belum ada rencana pembangunan yang diajukan." />
                                @endforelse
                            </x-table>
                        </div>
                        ...
                        @php
                            ...
                            $barisPengajuan = collect($daftarPengajuan)->map(function ($item) {
                                ...
                                foreach ($kategoriKeys as $kunci) {
                                    ...
                                    $chips[] = [
                                        'label' => \App\Http\Controllers\User\PengajuanController::categoryLabel(
                                            $kunci,
                                        ),
                                        'detail' => count($detail)
                                            ? implode(' · ', $detail)
                    ...
                    <x-modal id="hapusDataSekolahModal" size="sm" centered>
                        ...
                        <div class="text-center py-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <strong>{{ $profileSekolah->nama_sekolah }}</strong>
                                (jumlah siswa, rombel, ruang kelas, fasilitas, furnitur, dst)
